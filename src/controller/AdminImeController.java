...
public class AdminImeController {
	...
	void initialize(){
		...
		col_item_barcode.setMinWidth(100.0);
		col_buying_price.setMinWidth(60.0);
		col_selling_price.setMinWidth(60.0);
		col_mobile_brand.setMinWidth(80.0);
		col_color.setMinWidth(60.0);
		col_ram.setMinWidth(60.0);
		col_rom.setMinWidth(60.0);
		col_ime_number.setMinWidth(60.0);
		col_item_categroy.setMinWidth(60.0);
		col_item_supplier.setMinWidth(100.0);
		col_item_dateadded.setMinWidth(160.0);
		col_item_stock.setMinWidth(60.0);
		col_item_price.setMinWidth(60.0);

		col_item_barcode.setStyle("-fx-font-size: 14");
		col_mobile_brand.setStyle("-fx-font-size: 14");
		col_buying_price.setStyle("-fx-font-size: 14");
		col_selling_price.setStyle("-fx-font-size: 14");
		col_color.setStyle("-fx-font-size: 14");
		col_ram.setStyle("-fx-font-size: 14");
		col_rom.setStyle("-fx-font-size: 14");
		col_ime_number.setStyle("-fx-font-size: 14");
